...
class ImageWidthHeightTest {
    ...
    public static final ImageWidthHeight standardImageWidthHeight = new ImageWidthHeight(0L,0L,300,200);

    @Test
    @DisplayName("width는 300 이상이어야 함")
    void 너비_300_이상() {
        Assertions.assertThatCode(() -> new ImageWidthHeight(0L,0L,300,200))
    ...
    void 너비_300_미만_예외_발생() {
        Assertions.assertThatThrownBy(
                () -> new ImageWidthHeight(0L,0L,299, 200))
    ...
    void 높이_200_미만_예외_발생() {
        Assertions.assertThatThrownBy(
                () -> new ImageWidthHeight(0L,0L,300, 199))
    ...
    void 너비_높이_비율_3대_2가_아닌경우_예외_발생() {
        Assertions.assertThatThrownBy(
                () -> new ImageWidthHeight(0L,0L,400, 200))
